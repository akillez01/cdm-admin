...
CREATE INDEX idx_daime_inventory_codigo ON daime_inventory(codigo);
CREATE INDEX idx_daime_inventory_status ON daime_inventory(status);
CREATE INDEX idx_daime_inventory_graduacao ON daime_inventory(graduacao);
CREATE INDEX idx_daime_inventory_data_feitio ON daime_inventory(data_feitio);
...
CREATE TRIGGER update_daime_inventory_updated_at 
